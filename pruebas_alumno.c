...
void buscar_comando_con_nombre_o_alias_valido()
{
	...
	pa2m_afirmar(
		cmd_aux != NULL,
		"Se buscar el comando C mediante el alias Contar y se encuentra");
	pa2m_afirmar(strcmp(comando_nombre(cmd_aux), "C") == 0,
		     "El nombre del comando es C");
...
void buscar_comando_con_nombre_o_alias_null_o_inexistente()
{
	...
	pa2m_afirmar(!cmd_aux, "Se buscar comando NULL y no se encuentra");
	cmd_aux = menu_contiene_comando(menu, "Enumerar");
	pa2m_afirmar(!cmd_aux,
		     "Se buscar el comando Enumerar y no se encuentra");
...
void pruebas_buscar_comando_menu()
{
	...
	buscar_comando_con_nombre_o_alias_null_o_inexistente();
}
...
void ejecutar_comando_valido_con_cosas_null_o_inexistentes()
{
	pa2m_nuevo_grupo("Ejecutar comando con función válida");
	menu_t *menu = menu_crear("Hospital Pokemon");
	comando_t *cmd1 = comando_crear("C", "Cuenta", "Cuenta hasta dos",
...
void pruebas_ejecutar_comando_menu()
{
	...
	ejecutar_comando_valido_con_cosas_null_o_inexistentes();
}
